    ...
    <div class="product-section section mt-5 mb-1"
        ...
        <div class="col-7">
            <div  class="input-group mb-3">
                <input style="border: 30%;" type="text" class="form-control" placeholder="Nhập tên phim cần tìm" aria-label="Username"
        ...
        <div class="col-2 align-middle">
            <div class="product-short ">
                    <select class="nice-select">
                        <option><p> Name Ascending</p></option>
        ...
        <div class="col-3">
            <button style="width: 100%; background-color: #ff708a;" class="search-toggle btnsearch btn align-end"><i class="fa-solid fa-magnifying-glass ms-1"></i><b>Tìm Kiếm</b></button>
        </div>
            ...
            <div class="">
                <div class="product-item">
                    <div class="product-inner">
                        <div class="image"><img style="width:270px;height:320px;"
                            ...
                            <div class="content-inner d-flex flex-column w-100">
                                <h4
                                    ...
                                    <div href="single-product.html" style="transform:translateY(-10px);"
                                        class="text-center m-auto">Doona! </div>
                                </h4>
                                <div class="ratting ms-1 fs-6" style="transform:translateY(-15px);"><i
                                        class="fa fa-star text-danger"></i><i class="fa fa-star text-danger"></i><i
                                        class="fa fa-star text-danger"></i><i class="fa fa-star-half-o text-danger"></i><i
                                        class="fa fa-star-o text-danger"></i></div>
                                <h5 class="size mt-3">Năm sản xuất: 2023 </h5>
                                <h5 class="color"> Thể loại: <b class="ms-1"> Tình Cảm</b></h5>
                            </div>
                        </div>
                    </div>
                </div>
